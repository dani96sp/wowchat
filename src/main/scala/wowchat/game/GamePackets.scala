...
trait GamePackets {
  ...
  val CMSG_GROUP_ACCEPT = 0x72

  val CMSG_INITIATE_TRADE = 0x116
  val CMSG_ACCEPT_TRADE = 0x11A

  val SMSG_TRADE_STATUS = 0x120
  val CMSG_BEGIN_TRADE = 0x117
  val CMSG_CANCEL_TRADE = 0x11C
  val SMSG_TRADE_STATUS_EXTENDED = 0x121
