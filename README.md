...
3. Run `mvn clean package` which will produce a file in the target folder called `wowchat-1.4.0.zip`
4. unzip `wowchat-1.4.0.zip`, edit the configuration file and run `java -jar wowchat.jar <config file>`
